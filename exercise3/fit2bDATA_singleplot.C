...
TFile *f00 = new TFile("DStar_2b_MC.root"); //type here the name of your root file
TString name = "deltaM"; // type here the name of the plot you want to fit
...
latexLabel2.SetNDC();
latexLabel2.DrawLatex(0.3, 0.93, " CMS Preliminary at #sqrt{s} = 13 TeV, 2018");

img->FromPad(c);
img->WriteImage(name+"_2b_MC.png");
